...
public class MainManager {
	...
	private static final int[][] mInput = new int[][] { { 3, SPARE }, { STRIKE, STRIKE_BUDDY },
			{ STRIKE, STRIKE_BUDDY }, { 7, 1 }, { 0, 3 }, { STRIKE, STRIKE_BUDDY }, { 9, SPARE }, { 4, 5 },
			{ STRIKE, STRIKE_BUDDY }, { 3, SPARE, 1 } };
	...
	void iterateWaitingList(int row, int currentVal) {
		...
		for (int i = 0; i < mWaitingList.size(); i++) {
			...
			// To consider if waiting list index is having object of row-1 th or row-2 th
			// object
